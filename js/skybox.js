...
function createMaterials(){
     ...
     const RainbowTexture = loadTexture.load("textures/texture2.jpg");
     ...
     const imgTexture = new THREE.TextureLoader().load( "textures/texture1.jpeg" );
...
function loadModels() {
  ...
  loader.load( 'models/cartoon_cloud/scene.gltf', gltf => onLoad( gltf, Position3, SkyboxMaterial), onProgress, onError );
